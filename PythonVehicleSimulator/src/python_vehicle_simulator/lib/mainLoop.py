...
def simulate(N, sampleTime, vehicle):
    ...
    for i in range(0,N+1):
        ...
        if (vehicle.controlMode == 'depthAutopilot'):
            ...
            rl_reward.append(vehicle.RL_reward())
            current_states.append(((vehicle.V_c, vehicle.vc_noise), (vehicle.beta_c, vehicle.betac_noise)))
    ...
    if len(rl_reward):
        return (simTime,simData), rl_reward, current_states
